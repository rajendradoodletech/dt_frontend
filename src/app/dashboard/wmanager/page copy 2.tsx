...
import { MenuIcon,Ellipsis,Plus } from "lucide-react"
    ...
    <div className="flex flex-col h-screen w-full mx-auto md:flex-row">
      <div className="bg-muted border-r w-full md:w-[300px] md:block">
        ...
        <div className="divide-y">
          <div className="p-4">
            ...
            <Carousel>
              <CarouselContent className="flex flex-row gap-1">
                {['John', 'Jane', 'Alex','John', 'Jane', 'Alex','John', 'Jane', 'Alex'].map((name, idx) => (
                  <CarouselContactItem key={idx} name={name} src="/placeholder-user.jpg" fallback={name[0]} />
                ))}
              </CarouselContent>
          ...
          {['John Doe', 'Jane Smith', 'Alex Johnson'].map((name, idx) => (
            <ContactItem key={idx} name={name} src="/placeholder-user.jpg" fallback={name.split(' ')[0][0]} time="2:34 PM" message="Sample message" />
          ))}
        </div>
      </div>
      <div className="flex-1 flex flex-col">
        ...
        <div className="bg-muted border-t p-4 flex items-center gap-4">
          <Input placeholder="Type your message..." className="flex-1 bg-muted-foreground/10 border-none focus:ring-0" />
          <Button variant="ghost" size="icon" className="rounded-full">
        ...
        <div className="divide-y">
          <div className="flex flex-col items-center gap-4 p-4">
            <Avatar className="w-24 h-24 rounded-full">
              <AvatarImage src="..public/User3.png" />
              <AvatarFallback>JD</AvatarFallback>
            </Avatar>
            <div className="flex-1 truncate">
              <div className="font-medium">John Doe</div>
              <div className="text-sm text-muted-foreground truncate">Active now</div>
            </div>
          </div>
          <div className="p-4">
            <div className="font-medium mb-2">Status</div>
            <Badge variant="outline" className="w-full py-2">Online</Badge>
          </div>
          <div className="p-4">
            <Card className ="flex gap-1 bg-transparent">  <Badge className="gap-2">Cloud<Ellipsis className="w-4 h-4" /></Badge><Badge className="gap-2">Lorem ipsum<Ellipsis className="w-4 h-4" /></Badge><Badge className="gap-2">Cloud Services <Ellipsis className="w-4 h-4" /></Badge><Badge className="gap-2">Cloud Services <Ellipsis className="w-4 h-4" /></Badge> <button>Add New <Plus/></button></Card>
            <div className="text-sm text-muted-foreground mt-2">Notes1</div>
          </div>
        </div>
      </div>
    </div>
